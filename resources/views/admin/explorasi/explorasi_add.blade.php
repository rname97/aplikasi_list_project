        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ url('/addExplorasi') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Nama explorasi</label>
                            <div class="col-sm-10">
                                <input type="text" name="explorasiName" class="form-control" id="basic-default-name" placeholder="">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="explorasiDeskripsi" class="form-control" id="basic-default-name" placeholder="">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="explorasiImageCover" class="form-control" id="basic-default-name">
                            </div>

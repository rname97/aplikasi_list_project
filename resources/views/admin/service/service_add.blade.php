                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/addService') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="serviceName" class="form-control" id="basic-default-name" placeholder="">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="serviceDeskripsi" class="form-control" id="basic-default-name" placeholder="">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="serviceIcon" class="form-control" id="basic-default-name" placeholder="">
                            </div>
